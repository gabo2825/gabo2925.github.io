if (Math.random() <= 1/100) {
    ...
    clips=['Try chair, chair2, light, leg, tail, stinky, split, reset, love.',
           ...
           'she loves me so much SWOONER https://www.twitch.tv/kaestrain/clip/LuckyVastEagleCoolStoryBob-AlbEWfmfhHQ8Pqq3?filter=clips&range=30d&sort=time'];

    c=['terms','chair','chair2','light','leg','tail','stinky','split','reset','love'];
    i=c.indexOf(q);
    if(i!=-1) {
      clips[i]+" lycelYes";
    }
