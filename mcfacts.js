...
const facts=[" Minecraft is a SANDBOX GAME?? ",
             ...
             " 08The landscape of Minecraft is called Biomes. ",
             " 09The Nether is a dimension outside the world of Minecraft. ",
             " 10The End is the final Biome to explore in Minecraft. ",
             " 11Enderman is a three-block-tall mob that brings chaos in the game. ",
             " 12The Ender Dragon of Minecraft attacks and destroys the blocks. ",
             " 13Dragon Egg is an egg-shaped block that serves as a trophy and decoration. ",
             " Watch out for the three-headed Wither Boss of Minecraft. ",
             " 15Minecraft has an adventure mode. ",
             " 16You only get one chance in the hardcore mode of Minecraft. ",
             " 17You can just be a spectator through the spectator mode. ",
             " 18Play with your friends through the multiplayer mode. ",
